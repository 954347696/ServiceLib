...
public class PuzzleView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.IcsPuzzleView);
        lineSize = ta.getInt(R.styleable.IcsPuzzleView_ics_line_size, 4);
        lineColor = ta.getColor(R.styleable.IcsPuzzleView_ics_line_color, ContextCompat.getColor(getContext(), R.color.easy_photos_fg_primary));
        selectedLineColor =
                ta.getColor(R.styleable.IcsPuzzleView_ics_selected_line_color, ContextCompat.getColor(getContext(), R.color.easy_photos_fg_accent));
        handleBarColor =
                ta.getColor(R.styleable.IcsPuzzleView_ics_handle_bar_color, ContextCompat.getColor(getContext(), R.color.easy_photos_fg_accent));
        piecePadding = ta.getDimensionPixelSize(R.styleable.IcsPuzzleView_ics_piece_padding, 0);
        needDrawLine = ta.getBoolean(R.styleable.IcsPuzzleView_ics_need_draw_line, false);
        needDrawOuterLine = ta.getBoolean(R.styleable.IcsPuzzleView_ics_need_draw_outer_line, false);
        duration = ta.getInt(R.styleable.IcsPuzzleView_ics_animation_duration, 300);
        pieceRadian = ta.getFloat(R.styleable.IcsPuzzleView_ics_radian, 0f);
        ta.recycle();
