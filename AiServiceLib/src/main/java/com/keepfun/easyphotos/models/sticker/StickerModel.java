package com.keepfun.easyphotos.models.sticker;
...
import com.keepfun.easyphotos.models.sticker.cache.StickerCache;
import com.keepfun.easyphotos.models.sticker.entity.TextStickerData;
import com.keepfun.easyphotos.models.sticker.listener.OnStickerClickListener;
import com.keepfun.easyphotos.models.sticker.view.BitmapSticker;
import com.keepfun.easyphotos.models.sticker.view.EditFragment;
import com.keepfun.easyphotos.models.sticker.view.TextSticker;
...
public class StickerModel {
    ...
    public void save(Activity act, ViewGroup stickerGroup, View imageGroup, int imageWidth, int imageHeight, final String dirPath, final String namePrefix, final boolean notifyMedia, final SaveBitmapCallBack callBack) {
        ...
        com.keepfun.easyphotos.EasyPhotos.saveBitmapToDir(act, dirPath, namePrefix, saveBitmap, notifyMedia, callBack);
