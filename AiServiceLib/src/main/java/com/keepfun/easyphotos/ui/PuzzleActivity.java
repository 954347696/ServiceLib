...
import com.keepfun.easyphotos.models.puzzle.Area;
import com.keepfun.easyphotos.models.puzzle.DegreeSeekBar;
import com.keepfun.easyphotos.models.puzzle.PuzzleLayout;
import com.keepfun.easyphotos.models.puzzle.PuzzlePiece;
import com.keepfun.easyphotos.models.puzzle.PuzzleUtils;
import com.keepfun.easyphotos.models.puzzle.PuzzleView;
import com.keepfun.easyphotos.models.sticker.StickerModel;
import com.keepfun.easyphotos.setting.Setting;
import com.keepfun.easyphotos.ui.adapter.PuzzleAdapter;
import com.keepfun.easyphotos.ui.adapter.TextStickerAdapter;
import com.keepfun.easyphotos.utils.bitmap.SaveBitmapCallBack;
...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onClick(View view) {
        ...
        if (R.id.tv_back == id) {
            ...
            toggleIvMenu(R.id.iv_replace);
            if (null == toClass) {
                com.keepfun.easyphotos.EasyPhotos.createAlbum(this, true, Setting.imageEngine).setCount(1).start(91);
            } else {
        ...
        stickerModel.save(this, mRootView, puzzleView, puzzleView.getWidth(),
                ...
                new SaveBitmapCallBack() {
                    ...
                    public void onSuccess(File file) {
                        ...
                        intent.putExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_PHOTOS, photo);
        ...
        switch (resultCode) {
            case RESULT_OK:
                ...
                ArrayList<Photo> photos =
                        data.getParcelableArrayListExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_PHOTOS);
