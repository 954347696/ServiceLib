package com.keepfun.easyphotos.ui;
...
import com.keepfun.easyphotos.constant.Code;
import com.keepfun.easyphotos.constant.Key;
import com.keepfun.easyphotos.models.ad.AdListener;
import com.keepfun.easyphotos.models.album.AlbumModel;
import com.keepfun.easyphotos.models.album.entity.Photo;
import com.keepfun.easyphotos.result.Result;
import com.keepfun.easyphotos.setting.Setting;
import com.keepfun.easyphotos.ui.adapter.AlbumItemsAdapter;
import com.keepfun.easyphotos.ui.adapter.PhotosAdapter;
import com.keepfun.easyphotos.ui.widget.PressedTextView;
import com.keepfun.easyphotos.utils.Color.ColorUtils;
import com.keepfun.easyphotos.utils.String.StringUtils;
import com.keepfun.easyphotos.utils.bitmap.BitmapUtils;
import com.keepfun.easyphotos.utils.media.DurationUtils;
import com.keepfun.easyphotos.utils.media.MediaScannerConnectionUtils;
import com.keepfun.easyphotos.utils.permission.PermissionUtil;
import com.keepfun.easyphotos.utils.settings.SettingsUtils;
import com.keepfun.easyphotos.utils.system.SystemUtils;
import com.keepfun.easyphotos.utils.uri.UriUtils;
...
//        super.onActivityResult(requestCode, resultCode, data);
    ...
    private void onCameraResultForQ() {
        ...
        if (Setting.onlyStartCamera || albumModel.getAlbumItems().isEmpty()) {
            ...
            data.putParcelableArrayListExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_PHOTOS, resultList);
            data.putExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_SELECTED_ORIGINAL, Setting.selectedOriginal);
    ...
    private void initView() {
        ...
        com.keepfun.easyphotos.EasyPhotos.setAdListener(this);
    ...
    private void done() {
        ...
        intent.putParcelableArrayListExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_PHOTOS, resultList);

        intent.putExtra(com.keepfun.easyphotos.EasyPhotos.RESULT_SELECTED_ORIGINAL, Setting.selectedOriginal);
