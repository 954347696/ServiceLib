...
public class ChatMessage {
    ...
    public static class Request extends ChatMessage {
    ...
    public static class Response extends ChatMessage {
    ...
    public static class Notification extends ChatMessage {
    ...
    public static ChatMessage parse(String raw) {
        ChatLogger.d(TAG, "parse() ");
        JSONObject object;
        try {
            object = new JSONObject(raw);
        } catch (JSONException e) {
            ChatLogger.e(TAG, String.format("parse() | invalid JSON: %s", e.getMessage()));
            return null;
        }
        ...
        if (object.optBoolean("request")) {
            ...
            if (TextUtils.isEmpty(method)) {
                ChatLogger.e(TAG, "parse() | missing/invalid method field. rawData: " + raw);
                return null;
            }
            if (id == 0) {
                ChatLogger.e(TAG, "parse() | missing/invalid id field. rawData: " + raw);
                return null;
            }
            ...
            // Invalid.
            ChatLogger.e(TAG, "parse() | missing request/response field. rawData: " + raw);
            return null;
        }
    }
    ...
    public static JSONObject createRequest(String method, JSONObject data) {
        ...
        try {
            ...
            request.put("id", ChatUtils.generateRandomNumber());
