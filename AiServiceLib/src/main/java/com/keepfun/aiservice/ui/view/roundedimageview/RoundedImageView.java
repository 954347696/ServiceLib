package com.keepfun.aiservice.ui.view.roundedimageview;
...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IcsRoundedImageView, defStyle, 0);

        int index = a.getInt(R.styleable.IcsRoundedImageView_android_scaleType, -1);
        if (index >= 0) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.IcsRoundedImageView_ics_riv_border_width, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = a.getColorStateList(R.styleable.IcsRoundedImageView_ics_riv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mMutateBackground = a.getBoolean(R.styleable.IcsRoundedImageView_ics_riv_mutate_background, false);
        mIsOval = a.getBoolean(R.styleable.IcsRoundedImageView_ics_riv_oval, false);
        mIsSquare = a.getBoolean(R.styleable.IcsRoundedImageView_ics_riv_square, false);

        final int tileMode = a.getInt(R.styleable.IcsRoundedImageView_ics_riv_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.IcsRoundedImageView_ics_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.IcsRoundedImageView_ics_riv_tile_mode_y, TILE_MODE_UNDEFINED);
