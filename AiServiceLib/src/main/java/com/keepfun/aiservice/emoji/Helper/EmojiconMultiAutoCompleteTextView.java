...
public class EmojiconMultiAutoCompleteTextView extends MultiAutoCompleteTextView {
    ...
    private void init(AttributeSet attrs) {
        ...
        mEmojiconAlignment = a.getInt(R.styleable.IcsEmojicon_icsEmojiconAlignment, DynamicDrawableSpan.ALIGN_BASELINE);
        mUseSystemDefault = a.getBoolean(R.styleable.IcsEmojicon_icsEmojiconUseSystemDefault, false);
        a.recycle();
        mEmojiconTextSize = (int) getTextSize();
        setText(getText());
    }
