 ...
 */
package com.keepfun.aiservice.emoji.Actions;
...
import com.keepfun.aiservice.emoji.Helper.EmojiconGridView;
import com.keepfun.aiservice.emoji.Helper.EmojiconsPopup;
...
//                changeEmojiKeyboardIcon(emojiButton, KeyBoardIcon);
    ...
    public void togglePopupVisibility() {
        if (!popup.isShowing()) {
            ...
            hidePopup();
            if (keyboardListener != null) {
                keyboardListener.toggleKeyboard();
            }
        }
    }
