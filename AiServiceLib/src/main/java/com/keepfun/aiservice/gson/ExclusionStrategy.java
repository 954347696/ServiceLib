 ...
 * </pre>
 *
 * <p>Now if you want to configure {@code EGson} to use a user defined exclusion strategy, then
 * the {@code GsonBuilder} is required. The following is an example of how you can use the
 * {@code GsonBuilder} to configure EGson to use one of the above sample:
 * <pre class="code">
