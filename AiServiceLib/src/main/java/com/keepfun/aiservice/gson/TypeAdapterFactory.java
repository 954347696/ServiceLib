 ...
 * multiset's type token. A {@code EGson} is passed in to {@code create} for
 * just this purpose: <pre>   {@code
 *
 *   public class MultisetTypeAdapterFactory implements TypeAdapterFactory {
 *     public <T> TypeAdapter<T> create(EGson gson, TypeToken<T> typeToken) {
 ...
 * the foundation of how EGson converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(EGson EGson, TypeToken<T> type);
}
