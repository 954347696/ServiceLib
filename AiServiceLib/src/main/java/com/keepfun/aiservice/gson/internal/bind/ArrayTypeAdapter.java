...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
    ...
    public <T> TypeAdapter<T> create(EGson EGson, TypeToken<T> typeToken) {
      ...
      TypeAdapter<?> componentTypeAdapter = EGson.getAdapter(TypeToken.get(componentType));
      return new ArrayTypeAdapter(
              EGson, componentTypeAdapter, $Gson$Types.getRawType(componentType));
    }
  };
  ...
  public ArrayTypeAdapter(EGson context, TypeAdapter<E> componentTypeAdapter, Class<E> componentType) {
