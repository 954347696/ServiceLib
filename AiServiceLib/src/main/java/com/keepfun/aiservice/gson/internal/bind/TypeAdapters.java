...
import com.keepfun.aiservice.gson.JsonIOException;
import com.keepfun.aiservice.gson.JsonNull;
import com.keepfun.aiservice.gson.JsonObject;
...
import com.keepfun.aiservice.gson.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> TypeAdapter<T> create(EGson EGson, TypeToken<T> typeToken) {
            ...
            final TypeAdapter<Date> dateTypeAdapter = EGson.getAdapter(Date.class);
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
        ...
        return new TypeAdapterFactory() {
            ...
            @Override
            public <T2> TypeAdapter<T2> create(EGson EGson, TypeToken<T2> typeToken) {
