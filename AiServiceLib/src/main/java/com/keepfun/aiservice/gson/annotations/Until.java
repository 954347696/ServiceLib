...
package com.keepfun.aiservice.gson.annotations;
 ...
 * Basically, if EGson is created with a version number that exceeds the value stored in the
 ...
 * EGson with {@code EGson gson = new GsonBuilder().setVersion(1.2).create()} then the
 * {@code toJson()} and {@code fromJson()} methods of EGson will exclude the {@code emailAddress}
