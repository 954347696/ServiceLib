...
import com.keepfun.aiservice.gson.FieldNamingStrategy;
...
import com.keepfun.aiservice.gson.annotations.JsonAdapter;
...
import com.keepfun.aiservice.gson.internal.reflect.ReflectionAccessor;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
  ...
  @Override
  public <T> TypeAdapter<T> create(EGson EGson, final TypeToken<T> type) {
    ...
    return new Adapter<T>(constructor, getBoundFields(EGson, type, raw));
  }

  private BoundField createBoundField(
          final EGson context, final Field field, final String name,
  ...
  private Map<String, BoundField> getBoundFields(EGson context, TypeToken<?> type, Class<?> raw) {
