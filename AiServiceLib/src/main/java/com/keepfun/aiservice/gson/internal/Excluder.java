...
package com.keepfun.aiservice.gson.internal;


import com.keepfun.aiservice.gson.EGson;
import com.keepfun.aiservice.gson.ExclusionStrategy;
import com.keepfun.aiservice.gson.FieldAttributes;
import com.keepfun.aiservice.gson.TypeAdapter;
import com.keepfun.aiservice.gson.TypeAdapterFactory;
import com.keepfun.aiservice.gson.annotations.Expose;
import com.keepfun.aiservice.gson.annotations.Since;
import com.keepfun.aiservice.gson.annotations.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  public <T> TypeAdapter<T> create(final EGson EGson, final TypeToken<T> type) {
    ...
    return new TypeAdapter<T>() {
      ...
      private TypeAdapter<T> delegate() {
        ...
        return d != null
            ? d
            : (delegate = EGson.getDelegateAdapter(Excluder.this, type));
      }
    };
  }
