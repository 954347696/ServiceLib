...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
    ...
    public <T> TypeAdapter<T> create(EGson EGson, TypeToken<T> type) {
      if (type.getRawType() == Object.class) {
        return (TypeAdapter<T>) new ObjectTypeAdapter(EGson);
      }
      return null;
    }
  };

  private final EGson EGson;

  ObjectTypeAdapter(EGson EGson) {
    this.EGson = EGson;
  }
  ...
  public void write(JsonWriter out, Object value) throws IOException {
    ...
    TypeAdapter<Object> typeAdapter = (TypeAdapter<Object>) EGson.getAdapter(value.getClass());
