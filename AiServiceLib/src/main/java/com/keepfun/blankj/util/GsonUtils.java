...
public final class GsonUtils {
    ...
    private static final Map<String, EGson> GSONS = new ConcurrentHashMap<>();
    ...
    /**
     * Set the delegate of {@link EGson}.
     *
     * @param delegate The delegate of {@link EGson}.
     */
    public static void setGsonDelegate(EGson delegate) {
        if (delegate == null) return;
        GSONS.put(KEY_DELEGATE, delegate);
    }

    /**
     * Set the {@link EGson} with key.
     *
     * @param key  The key.
     * @param gson The {@link EGson}.
     */
    public static void setGson(final String key, final EGson gson) {
        if (TextUtils.isEmpty(key) || gson == null) return;
        GSONS.put(key, gson);
    }

    /**
     * Return the {@link EGson} with key.
     *
     * @param key The key.
     * @return the {@link EGson} with key
     */
    public static EGson getGson(final String key) {
        return GSONS.get(key);
    }

    public static EGson getGson() {
        EGson gsonDelegate = GSONS.get(KEY_DELEGATE);
        if (gsonDelegate != null) {
            return gsonDelegate;
        }
        EGson gsonDefault = GSONS.get(KEY_DEFAULT);
        if (gsonDefault == null) {
     ...
     * @return object serialized into json.
     */
    public static String toJson(@NonNull final EGson gson, final Object object) {
     ...
     * @return object serialized into json.
     */
    public static String toJson(@NonNull final EGson gson, final Object src, @NonNull final Type typeOfSrc) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NonNull final EGson gson, final String json, @NonNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NonNull final EGson gson, final String json, @NonNull final Type type) {
        return gson.fromJson(json, type);
    }
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NonNull final EGson gson, final Reader reader, @NonNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NonNull final EGson gson, final Reader reader, @NonNull final Type type) {
        return gson.fromJson(reader, type);
    }
    ...
    static EGson getGson4LogUtils() {
        EGson gson4LogUtils = GSONS.get(KEY_LOG_UTILS);
    ...
    private static EGson createGson() {
