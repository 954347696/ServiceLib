...
public final class ToastUtils {
    ...
    private static synchronized void show(final CharSequence text, final int duration) {
    ...
    private static synchronized void show(final View view, final int duration) {
        UtilsBridge.runOnUiThread(() -> {
            cancel();
