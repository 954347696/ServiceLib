package com.keepfun.imageselector.utils;
...
import com.keepfun.imageselector.ClipImageActivity;
import com.keepfun.imageselector.ImageSelectorActivity;
...
public class ImageSelector {
    ...
    public static class ImageSelectorBuilder {
        ...
        /**
         * 是否裁剪圆形。默认false。如果使用了图片剪切功能，相册只能单选。
         *
         * @param isCircle
         * @return
         */
        public ImageSelectorBuilder setCircle(boolean isCircle) {
        ...
        public void start(Activity activity, int requestCode) {
            if (isCrop) {
                ClipImageActivity.openActivity(activity, requestCode, isViewImage, useCamera, isCircle, selected);
            } else {
        ...
        public void start(Fragment fragment, int requestCode) {
            if (isCrop) {
                ClipImageActivity.openActivity(fragment, requestCode, isViewImage, useCamera, isCircle, selected);
            } else {
