...
import com.keepfun.imageselector.adapter.FolderAdapter;
import com.keepfun.imageselector.adapter.ImageAdapter;
import com.keepfun.imageselector.entry.Folder;
import com.keepfun.imageselector.entry.Image;
import com.keepfun.imageselector.model.ImageModel;
import com.keepfun.imageselector.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void changeTime() {
        ...
        if (firstVisibleItem >= 0 && firstVisibleItem < mAdapter.getItemCount()) {
...
//            ToastUtils.setToastStrShort(this, "没有图片", Toast.LENGTH_LONG).show();
            return;
        }
